...
public class AddressBook {
	public static void main(String[] args) {
		...
		// DISPLAYING ALL address books Existing
		System.out.println("\n Text files");
		File directoryPath = new File(
				"C:\\Users\\ajay8\\eclipse\\java-2020-09\\Address_Book_Java\\src\\com\\addressbook");
	...
	private static void deleteAddresssBook(String addressBookName) {
		...
		if (file.delete()) {
			...
			System.out.println("Failed to delete the file from address book");
		}
	}
